  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6 flex flex-col items-center">
      <div className="relative w-full max-w-4xl">
        <div className="h-[200px] bg-gradient-to-r from-green-500 to-green-500 rounded-xl shadow-lg"></div>
        <img
          src={user.photoURL}
          alt=""
          className="w-[150px] h-[150px] rounded-full bg-green-700 border-4 border-white shadow-lg absolute left-1/2 transform -translate-x-1/2 -bottom-12"
        />
      </div>
